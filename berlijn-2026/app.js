...
const imageSearch = title => "https://www.google.com/search?tbm=isch&q=" + encodeURIComponent(title + " Berlin");
const videoFor = stop => stop.video || ("https://www.youtube.com/results?search_query=" + encodeURIComponent(stop.title + " Berlin"));
const best = (leg,mode) => {
